/*@HARUKO >> FPS++*/
// TODO: Colossus (copy the entire class, lel)
...
public class MathHelper
{
	...
	static
	{
		...
		{
			SIN_TABLE[var0] = (float)Math.sin((double)var0 * Math.PI * 2.0D / 4096.0D);
		}
	}
	...
	{
		return SIN_TABLE[(int)(par0 * 651.8986F) & 4095];
	}
	...
	{
		return SIN_TABLE[(int)(par0 * 651.8986F + 1024.0F) & 4095];
	}
