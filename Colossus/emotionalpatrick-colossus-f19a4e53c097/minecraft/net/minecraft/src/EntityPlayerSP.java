...
public class EntityPlayerSP extends EntityPlayer
{
	...
	{
		// TODO: Colossus
		float dwm = distanceWalkedModified;
		boolean speedState = Colossus.getManager().getModuleByName("speed").isEnabled();
		if (speedState && !mc.thePlayer.isJumping) {
			par1 *= 1 + Values.speedHack.getValue();
			par5 *= 1 + Values.speedHack.getValue();
		}
		super.moveEntity(par1, par3, par5);
		if (speedState) {
			distanceWalkedModified = dwm;
		}
	}
