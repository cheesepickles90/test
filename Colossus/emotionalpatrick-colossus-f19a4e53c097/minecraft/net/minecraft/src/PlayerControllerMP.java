...
public class PlayerControllerMP
{
	...
	{
		HookManager.onClickBlock(par1, par2, par3, par4);
	...
	public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
	{
		...
		{
			this.blockHitDelay = Colossus.getManager().getModuleByName("Speedy Gonzales").isEnabled() ? HookManager.onBlockHitDelay(this.blockHitDelay) : 5;
			this.netClientHandler.addToSendQueue(new Packet14BlockDig(0, par1, par2, par3, par4));
			clickBlockCreative(this.mc, this, par1, par2, par3, par4);
		}
		else
		{
			if (this.func_85182_a(par1, par2, par3))
			{
				...
				this.curBlockDamageMP += HookManager.curBlockDamageSet(var6, par1, par2, par3, this.curBlockDamageMP);
