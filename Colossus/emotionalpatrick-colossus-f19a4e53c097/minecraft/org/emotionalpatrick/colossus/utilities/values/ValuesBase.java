package org.emotionalpatrick.colossus.utilities.values;
...
public class ValuesBase {
	...
	public static ArrayList<ValuesBase> list = new ArrayList<ValuesBase>();

	public ValuesBase(String s, float v, float m, float s1, float s2) {
		value = v;
		name = s;
		minimal = m;
		safety = s2;
	...
	public ValuesBase(String s, float v, float m) {
		value = v;
		name = s;
		minimal = m;
		safety = -1f;
