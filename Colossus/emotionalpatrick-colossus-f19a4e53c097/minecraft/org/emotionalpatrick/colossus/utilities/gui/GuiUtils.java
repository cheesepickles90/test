package org.emotionalpatrick.colossus.utilities.gui;
...
public class GuiUtils {
	...
	public static void renderImage(int x, int y) {
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
		renderFace("dead.png", x, y, 2.0F, 0.0F, 254.0F,
				256.0F, 2.0F);
	}
	  
	public static void renderFace(String s, int paramInt1, int paramInt2,
			float paramFloat1, float paramFloat2, float paramFloat3,
			float paramFloat4, float paramFloat5) {
		GL11.glEnable(3553);
		GL11.glDisable(2929);
		GL11.glEnable(3042);
		GL11.glScalef(1.0F / paramFloat5, 1.0F / paramFloat5,
				1.0F / paramFloat5);
		Wrapper.getMinecraft().renderEngine.bindTexture(Wrapper
				.getMinecraft().renderEngine.getTexture("/misc/colossus/"
				+ s));
		drawTexturedRect(paramInt1 * paramFloat5, paramInt2 * paramFloat5,
				paramFloat1, paramFloat2, paramFloat3, paramFloat4);
		GL11.glScalef(paramFloat5, paramFloat5, paramFloat5);
		GL11.glDisable(3042);
		GL11.glEnable(2929);
	}
	
	public static void drawButtonReliantOn(int x, int y, int state) 
	{
		...
		drawTexturedRect(x, y, uX[state - 1], uY, 48, 24);
		GL11.glScalef(2F, 2F, 2F);
		GL11.glDisable(GL11.GL_BLEND);
	}
	
	public static void drawButtonReliantOff(int x, int y, int state) 
	{
		Minecraft mc = Minecraft.getMinecraft();
	...
	public static void drawButtonReliant(float x, float y, int state) {
		...
		int uY = 1;
		GL11.glScalef(0.5F, 0.5F, 0.5F);
		Wrapper.getMinecraft().renderEngine.bindTexture(Wrapper.getMinecraft().renderEngine.getTexture("/misc/colossus/GuiRedux.png"));
	...
	public static void setupOverlayRendering()
    {
        ...
        GL11.glLoadIdentity();
        GL11.glOrtho(0.0D, Wrapper.getScreenWidth(), Wrapper.getScreenHeight(), 0.0D, 1000D, 3000D);
	...
	public void drawButtonRects(float x, float y, float x2, float y2, boolean var1) {
		GuiUtils.drawHollowBorderedRect(x, y, x2, y2, 0xFF13161D);
		GuiUtils.drawHollowBorderedRectCustom(x + 0.5F, y + 0.5F, x2 - 1, y2 - 1, var1 ? 0xFF1A587E : 0xFF4C4C4C, false);
		GuiUtils.drawHollowBorderedRectCustom(x + 1, y + 1, x2 - 0.5F, y2 - 0.5F, var1 ? 0xFF093B5B : 0xFF2E2E2E, true);
		//this.drawRect(x + 1F, y2 - 1, x + 1.5F, y2 - 2F, 0xFF400000);
		GuiUtils.drawGradientRect(x + 1, y + 1, x2 - 1, y2 - 1, var1 ? 0xFF1A587E : 0xFF3F3F3F, var1 ? 0xFF093B5B : 0xFF292929);
	}
