...
public class GL11Helper {
	...
	public static void drawBlockESP(double x, double y, double z, float r, float g, float b) {
		EntityPlayerSP ep = ColossusWrapper.getPlayer();
		double d = ep.lastTickPosX + (ep.posX - ep.lastTickPosX) * (double)ColossusWrapper.getMinecraft().timer.renderPartialTicks;
		double d1 = ep.lastTickPosY + (ep.posY - ep.lastTickPosY) * (double)ColossusWrapper.getMinecraft().timer.renderPartialTicks;
		double d2 = ep.lastTickPosZ + (ep.posZ - ep.lastTickPosZ) * (double)ColossusWrapper.getMinecraft().timer.renderPartialTicks;
		double d3 = x - d;
		double d4 = y - d1;
		double d5 = z - d2;
		GL11.glPushMatrix();
	...
	public static void enableDefaults() {
		ColossusWrapper.getRenderer().disableLightmap(0.0D);
		GL11.glEnable(3042);
		GL11.glDisable(2896);
		GL11.glDisable(2929);
		GL11.glEnable(2848);
	...
	public static void disableDefaults() {
		...
		ColossusWrapper.getRenderer().enableLightmap(0.0D);
	}
