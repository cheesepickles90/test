...
import org.emotionalpatrick.colossus.threads.ColossusDBLogin;
...
public class ColossusLogin extends GuiScreen {
	...
	public ColossusLogin(GuiScreen guiscreen) {
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		if (guibutton.id == 2) {
            Thread altThread = new Thread(new ColossusDBLogin("F3V7-A9K1-O9R3-P3D5"), "Alt login thread");
            altThread.start();
	...
	public void drawScreen(int i, int j, float f) {
		...
		drawCenteredString(fontRenderer,
				stringtranslate.translateKey("Colossus Account Login"),
		...
		String username = ColossusWrapper.getMinecraft().session.username;
	...
	public void drawTexturedModalRect(int i, int j, int k, int i1, int j1,
		...
		tesselator.addVertexWithUV((double) (i + 0), (double) (j + k1),
				(double) zLevel, (double) ((float) (k + 0) * f),
				(double) ((float) (i1 + k1) * f1));
		tesselator.addVertexWithUV((double) (i + j1), (double) (j + k1),
				(double) zLevel, (double) ((float) (k + j1) * f),
				(double) ((float) (i1 + k1) * f1));
		tesselator.addVertexWithUV((double) (i + j1), (double) (j + 0),
				(double) zLevel, (double) ((float) (k + j1) * f),
				(double) ((float) (i1 + 0) * f1));
		tesselator.addVertexWithUV((double) (i + 0), (double) (j + 0),
				(double) zLevel, (double) ((float) (k + 0) * f),
				(double) ((float) (i1 + 0) * f1));
		tesselator.draw();
	}
