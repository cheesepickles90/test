...
public class ColossusSliderHelper {
	...
	public ColossusSliderHelper(ModuleValues v, int x, int y, int w, int h, float m, String s, float f, ColossusPanelBase d) {
		this.x = x;
		this.y = y;
		width = w;
		height = h;
	...
	public ColossusSliderHelper(ModuleValues v, int x, int y, int w, int h, float m, String s, ColossusPanelBase d) {
		this.x = x;
		this.y = y;
		width = w;
		height = h;
