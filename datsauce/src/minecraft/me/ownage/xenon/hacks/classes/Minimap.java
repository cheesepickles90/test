...
public class Minimap {
	...
	public void render(float var1) {
		...
		this.mc.renderEngine.createTextureFromBytes(this.buffer, 128, 128, this.mapTexture);
	...
	public void tick() {
		int var1 = (int)this.mc.thePlayer.posX - 64;
		int var2 = (int)this.mc.thePlayer.posZ - 64;
	...
	public int getMapColorXZ(int var1, int var2) {
		Chunk var3 = this.mc.theWorld.getChunkFromBlockCoords(var1, var2);
		...
		if(var6 <= 0) {
			...
			if(var10 == null) {
				...
				int par4 = this.mc.theWorld.getBiomeGenForCoords(var1, var2).getBiomeFoliageColor();
				int par5 = this.mc.theWorld.getBiomeGenForCoords(var1, var2).getBiomeGrassColor();
				int par6 = this.mc.theWorld.getBiomeGenForCoords(var1, var2).waterColorMultiplier;
