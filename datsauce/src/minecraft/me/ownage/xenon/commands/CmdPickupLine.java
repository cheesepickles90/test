...
public class CmdPickupLine extends Command {
	public CmdPickupLine() {
		super("pickupline");
	}
	...
	public void runCommand(String s, String[] args) {
		try {
			String shit = HtmlManipulator.replaceHtmlEntities(Xenon.downloadString("http://pickuplinegenerator.com/api.asp").split(">")[1].split("<")[0]);
			if(shit.length() > Packet3Chat.maxChatLength) {
				shit = HtmlManipulator.replaceHtmlEntities(Xenon.downloadString("http://pickuplinegenerator.com/api.asp").split(">")[1].split("<")[0]);
			}
			Xenon.getMinecraft().thePlayer.sendChatMessage(shit);
		} catch(Exception e) {}
	}

	@Override
	public String getDescription() {
		return "Downloads a random pickup line.";
	}
	...
	public static final class HtmlManipulator
	{
	    /**
