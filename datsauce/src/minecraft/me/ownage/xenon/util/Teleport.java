...
public class Teleport
{
	...
	public static void sendFullUpdate(EntityPlayerSP entityplayersp, double d, double d1, double d2)
	{
		for(int i = 0; i < 2; i++)
		{
			...
			mc.getSendQueue().addToSendQueue(new Packet13PlayerLookMove(entityplayersp.posX, entityplayersp.boundingBox.minY, entityplayersp.posY, entityplayersp.posZ, entityplayersp.rotationYaw, entityplayersp.rotationPitch, true));
		}
