...
import me.ownage.xenon.hooks.XEntityClientPlayerMP;
import me.ownage.xenon.hooks.XGuiIngame;
import me.ownage.xenon.hooks.XPlayerController;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    public XPlayerController playerController;
    ...
    public XEntityClientPlayerMP thePlayer;
    ...
    public void startGame() throws LWJGLException
    {
        ...
        this.ingameGUI = new XGuiIngame(this);
    ...
    private void loadScreen() throws LWJGLException
    {
        ...
        this.renderEngine.bindTexture("/xenon/xenon.png");
    ...
    {
    	if((par1GuiScreen == null || par1GuiScreen == (GuiScreen) null) & theWorld == null) {
    		par1GuiScreen = Xenon.getDefaultScreen();
    	}
    	for(XenonMod mod: Hacks.hackList) {
    		GuiScreen ess = mod.onDisplayGuiScreen(par1GuiScreen);
    		if(ess == null) continue;
    		if(par1GuiScreen != ess || par1GuiScreen == (GuiScreen)null) {
    			par1GuiScreen = ess;
    		}
    	}
