...
public class GuiScreenSelectLocation extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.field_96237_d = new GuiSmallButton(6, this.width / 2 - 75, this.height - 38, var1.translateKey("gui.done")));
        this.field_96239_c = new SelectionListLocation(this);
        this.field_96239_c.registerScrollButtons(this.controlList, 7, 8);
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawCenteredString(this.fontRenderer, var4.translateKey("mco.create.world.location.title"), this.width / 2, 16, 16777215);
        this.drawCenteredString(this.fontRenderer, "(" + var4.translateKey("mco.create.world.location.warning") + ")", this.width / 2, this.height - 56, 8421504);
