...
public class GuiScreenCreateOnlineWorld extends GuiScreen
{
    ...
    {
        super.controlList = Collections.synchronizedList(new ArrayList());
    ...
    public void initGui()
    {
        ...
        this.controlList.add(new GuiButton(field_96253_d, this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, var1.translateKey("mco.create.world")));
        this.controlList.add(new GuiButton(field_96261_n, this.width / 2 + 5, this.height / 4 + 120 + 17, 95, 20, var1.translateKey("gui.cancel")));
    ...
    private void func_96250_g()
    {
        ...
        {
            this.controlList.add(new GuiButton(field_96262_o, this.width / 2 - 100, 135, this.field_96258_q.field_96395_b));
        }
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                GuiScreenSelectLocation var2 = new GuiScreenSelectLocation(this, this.field_96259_p, this.field_96258_q, this.field_96257_c.getText(), this.field_96255_b.getText());
    ...
    private void func_96252_h()
    {
        ...
        {
            String var1 = this.field_96255_b.getText() != null && !this.field_96255_b.getText().trim().equals("") ? this.field_96255_b.getText() : "Minecraft Realms Server";
            TaskWorldCreation var2 = new TaskWorldCreation(this, this.field_96257_c.getText(), var1, this.field_96258_q == null ? "NO_LOCATION" : this.field_96258_q.field_96396_a);
            GuiScreenLongRunningTask var3 = new GuiScreenLongRunningTask(this.mc, this.field_96260_a, var2);
            var3.func_98117_g();
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.drawString(this.fontRenderer, var4.translateKey("mco.configure.world.name"), this.width / 2 - 100, 42, 10526880);
        this.drawString(this.fontRenderer, var4.translateKey("mco.configure.world.description"), this.width / 2 - 100, 83, 10526880);

        if (this.field_96258_q != null)
        {
            this.drawString(this.fontRenderer, var4.translateKey("mco.configure.world.location"), this.width / 2 - 100, 124, 10526880);
        }
    ...
    {
        return par0GuiScreenCreateOnlineWorld.controlList;
    }
