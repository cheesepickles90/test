...
import me.ownage.xenon.hacks.classes.AntiVelocity;
...
public class NetClientHandler extends NetHandler
{
    ...
    {
        this.mc.playerController = new XPlayerController(this.mc, this);
    ...
    {
    	if(Hacks.findMod(AntiVelocity.class).isEnabled()) return;
