    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        while (var5 < this.options.keyBindings.length)
        {
            ...
            while (true)
            {
                ...
                {
                    ((GuiButton)this.controlList.get(var5)).displayString = "" + EnumChatFormatting.WHITE + "> " + EnumChatFormatting.YELLOW + "??? " + EnumChatFormatting.WHITE + "<";
                }
                else if (var6)
                {
                    ((GuiButton)this.controlList.get(var5)).displayString = EnumChatFormatting.RED + this.options.getOptionDisplayString(var5);
                }
                else
                {
