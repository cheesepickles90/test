...
public class GuiScreenConfirmation extends GuiYesNo
{
    ...
    public void initGui()
    {
        this.controlList.add(new GuiSmallButton(0, this.width / 2 - 155, this.height / 6 + 112, this.buttonText1));
        this.controlList.add(new GuiSmallButton(1, this.width / 2 - 155 + 160, this.height / 6 + 112, this.buttonText2));
    }
