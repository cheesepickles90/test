...
public class GuiScreenResetWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.field_96154_o = new GuiButton(1, this.width / 2 - 100, this.height / 4 + 96 + 12, var1.translateKey("mco.configure.world.buttons.reset")));
        this.controlList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 120 + 12, var1.translateKey("gui.cancel")));
