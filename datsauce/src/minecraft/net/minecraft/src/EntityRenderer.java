...
import me.ownage.xenon.hacks.classes.Brightness;
import me.ownage.xenon.hacks.classes.Tracer;
...
public class EntityRenderer
{
    ...
    private void setupCameraTransform(float par1, int par2)
    {
        ...
        if (this.mc.gameSettings.viewBobbing && !Hacks.findMod(Tracer.class).isEnabled())
        {
    ...
    private void updateLightmap(float par1)
    {
        ...
        if (var2 != null)
        {
            ...
            for (int var3 = 0; var3 < 256; ++var3)
            {
                ...
                var14 = ((Brightness)Hacks.findMod(Brightness.class)).fakeGamma;
                var15 = 1.0F - var11;
