...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.field_100003_c = new GuiButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, var1.translateKey("gui.done")));
        this.controlList.add(this.field_100002_d = new GuiButton(1, this.width / 2 - 100, this.height / 4 + 120 + 12, var1.translateKey("gui.cancel")));
