...
public class GuiMainMenu extends GuiScreen
{
    ...
    {
        this.controlList.add(new GuiButton(3, this.width / 2 - 100, par2 + par3 * 2, par1StringTranslate.translateKey("menu.online")));
    }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.field_92025_p != null && this.field_92025_p.length() > 0)
        {
            ...
            this.drawString(this.fontRenderer, field_96138_a, (this.width - this.field_92024_r) / 2, ((GuiButton)this.controlList.get(0)).yPosition - 12, 16777215);
        }
