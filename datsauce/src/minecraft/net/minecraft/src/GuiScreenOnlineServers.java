...
public class GuiScreenOnlineServers extends GuiScreen
{
    ...
    public void func_96178_g()
    {
        ...
        this.controlList.add(this.field_96196_r = new GuiButton(1, this.width / 2 - 154, this.height - 52, 100, 20, var1.translateKey("mco.selectServer.select")));
        this.controlList.add(this.field_96198_p = new GuiButton(2, this.width / 2 - 48, this.height - 52, 100, 20, var1.translateKey("mco.selectServer.create")));
        this.controlList.add(this.field_96190_o = new GuiButton(3, this.width / 2 + 58, this.height - 52, 100, 20, var1.translateKey("mco.selectServer.configure")));
        this.controlList.add(this.field_96197_q = new GuiButtonLink(4, this.width / 2 - 154, this.height - 28, 154, 20, var1.translateKey("mco.selectServer.moreinfo")));
        this.controlList.add(new GuiButton(0, this.width / 2 + 6, this.height - 28, 153, 20, var1.translateKey("gui.cancel")));
        ...
        if (par1GuiButton.enabled)
        {
            ...
            else if (par1GuiButton.id == 3)
            {
                ...
                if (var3 != null)
                {
                    ...
                    this.mc.displayGuiScreen(new GuiScreenConfigureWorld(this, var3));
                }
            }
