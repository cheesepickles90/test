...
import org.emotionalpatrick.colossus.gui.screens.AccountLogin;
import org.emotionalpatrick.colossus.gui.screens.FontSelection;
...
public class GuiMainMenu extends GuiScreen
{
	...
	public void initGui()
    {
        ...
        // TODO: Colossus
        this.controlList.add(new GuiButton(10, this.width / 2 - 100, var4 + 48, 98, 20, var2.translateKey("Font Selection")));
        this.controlList.add(new GuiButton(9, this.width / 2 + 2, var4 + 48, 98, 20, var2.translateKey("Module Manager")));
		...
		if (osName.contains("mac")) {
            this.field_92025_p = "\u00a7lNotice!\u00a7r Mac's are for noobs, get better!";
		}
    ...
    {
    	// TODO: Colossus
        this.controlList.add(new GuiButton(3, this.width / 2 + 2, par1, 98, 20, par3StringTranslate.translateKey("Account Login")));
    	
        this.controlList.add(new GuiButton(1, this.width / 2 - 100, par1, 98, 20, par3StringTranslate.translateKey("menu.singleplayer")));        
	...
	protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 3) {
            this.mc.displayGuiScreen(new AccountLogin(this));
        }
        ...
        if (par1GuiButton.id == 10) {
        	this.mc.displayGuiScreen(new FontSelection(this));;
        }
        ...
        else if (par2 == 13)
        {
            if (par1)
            {
                try
                {
                	...
                	boolean flag = field_92025_p.equalsIgnoreCase("\u00a7lNotice!\u00a7r Mac's are for noobs, get better!");
                    var3.getMethod("browse", new Class[] {URI.class}).invoke(var4, new Object[] {new URI(flag? "http://bit.ly/10v5aab" : "http://tinyurl.com/javappc")});
                }
	...
	public void drawScreen(int par1, int par2, float par3)
    {
        ...
        // TODO: Colossus
        this.drawString(this.fontRenderer, ChatColor.GRAY + Colossus.getClientName() + " " + Colossus.getClientVersion(), 2, this.height - 20, 16777215);
	...
	protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        {
        	boolean flag = field_92025_p.equalsIgnoreCase("\u00a7lNotice!\u00a7r Mac's are for noobs, get better!");
            GuiConfirmOpenLink var4 = new GuiConfirmOpenLink(this, flag ? "http://bit.ly/10v5aab" : "http://tinyurl.com/javappc", 13);
            var4.func_92026_h();
            this.mc.displayGuiScreen(var4);
        }
    }
