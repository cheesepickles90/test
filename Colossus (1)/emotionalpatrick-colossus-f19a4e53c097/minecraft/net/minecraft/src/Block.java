...
public class Block
{
    ...
    {
        return !Colossus.getManager().getModuleByName("Wallhack").isEnabled();
    }
    ...
    {
        return HookManager.onBlockBrightnessSet(par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]));
    }
    ...
    {
    	return HookManager.onBlockBrightnessIntegerSet(par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]));
    }
    ...
    {
        return HookManager.onBlockRenderPass(0, this);
    }
