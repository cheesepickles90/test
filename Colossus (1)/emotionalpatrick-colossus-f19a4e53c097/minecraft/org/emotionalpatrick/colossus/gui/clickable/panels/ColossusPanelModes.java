...
public class ColossusPanelModes extends ColossusPanelBase {

	public ColossusPanelModes(String s, int x, int y, int w, int h) {
		super(s, x, y, w, h);
	...
	public void init() {
		...
		while (i.hasNext()) {
			...
			if (!m.category.equalsIgnoreCase("Modes")) {
				continue;
			} else {
