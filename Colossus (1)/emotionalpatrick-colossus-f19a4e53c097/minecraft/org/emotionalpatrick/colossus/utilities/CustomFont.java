...
public class CustomFont
{
	...
	private void drawChar(Gui gui, char c, double i, double j) {
		...
		gui.drawTexturedModalRect(i, j - 2, xPos[(byte)c - startChar], yPos[(byte)c - startChar], (double)rectangle2d.getWidth(), (double)rectangle2d.getHeight() + metrics.getMaxDescent() + 2);
	}
}