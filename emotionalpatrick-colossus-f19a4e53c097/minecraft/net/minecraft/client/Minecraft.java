...
import org.emotionalpatrick.colossus.keybinds.KeybindManagerImpl;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    {
    	// TODO: Colossus
    	FileManagerImpl.getInstance().initSave();
    ...
    private void clickMouse(int par1)
    {
        if (par1 != 0 || this.leftClickCounter <= 0)
        {
            ...
            if (par1 == 1)
            {
                this.rightClickDelayTimer = Colossus.getManager().getModuleByName("FastPlace").isEnabled() ? HookManager.onRightClick(this.rightClickDelayTimer) : 4;
            }
            ...
            else if (this.objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                // TODO: Colossus
                HookManager.onPlayerClick(par1);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        {
                        	// TODO: Colossus
                        	KeybindManagerImpl.getInstance().runKeybinds(Keyboard.getEventKey());
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        // TODO: Colossus
        var13.setTitle("Minecraft - " + Colossus.getClientTitle());
