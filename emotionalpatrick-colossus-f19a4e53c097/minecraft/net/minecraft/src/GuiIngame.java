...
import org.emotionalpatrick.colossus.gui.ingame.IngameGUI;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (this.mc.gameSettings.showDebugInfo)
        {
            ...
            GL11.glPushMatrix();
            // TODO: Colossus
            var8.drawStringWithShadow(Colossus.getClientTitle() + " (" + this.mc.debug + ")", 2, 2, 16777215);
