...
import org.emotionalpatrick.colossus.gui.screens.ColossusPluginManager;
...
public class PluginSlot extends GuiSlot {
	...
	private ColossusPluginManager pModules;
	
	private int selected;
	private int updateCounter, modKey, herp;
	
	private boolean keyTyped;
    final ColossusPluginManager parentGui;
        
	public float r, g, b;
	Random rand = new Random();

	public PluginSlot(ColossusPluginManager mList) {
		super(ColossusWrapper.getMinecraft(), mList.width, mList.height, 32,
				mList.height - 59, 36);
		this.pModules = mList;
		this.selected = 0;
	...
	protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator) {
		...
		pModules.drawString(ColossusWrapper.getFontRenderer(), var1, j, k + 1,
				color);
		pModules.drawString(ColossusWrapper.getFontRenderer(), var2, j, k + 12,
				0x80808080);
		pModules.drawString(ColossusWrapper.getFontRenderer(), var3, j, k + 22,
				0x30303030);
	}
