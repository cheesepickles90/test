...
public class PasswordField extends Gui {
    ...
    public void drawTextBox()
    {
        ...
        {
			ScaledResolution var111 = new ScaledResolution(Wrapper.getMinecraft().gameSettings, Wrapper.getMinecraft().displayWidth, Wrapper.getMinecraft().displayHeight);
			int var1211 = var111.getScaledWidth();
			int var1311 = var111.getScaledHeight();
			int var1411 = Mouse.getX() * var1211 / Wrapper.getMinecraft().displayWidth;
			int var1611 = var1311 - Mouse.getY() * var1311 / Wrapper.getMinecraft().displayHeight - 1;
			
			boolean hover = var1411 >= this.xPos && var1411 < this.xPos + this.width && var1611 >= this.yPos && var1611 < this.yPos + this.height;
			boolean isRez = false;
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = this.fontRenderer.drawStringWithShadow(appendText(var10, "*"), var7, var8, var1);
            }
